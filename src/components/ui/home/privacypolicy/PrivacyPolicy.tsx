    ...
    <div className="mx-auto text-gray-800">
      ...
      <div className='flex flex-col justify-center items-center px-4 sm:px-40'>
        ...
        <p className="mb-4 px-4 sm:px-0 mt-5">
          ...
          <h2 className="text-xl sm:text-2xl font-semibold mt-6 mb-4 text-primary">Personal Data</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl sm:text-2xl font-semibold mt-6 mb-4 text-primary">Your rights in relation to personal data</h2>
          ...
          <h2 className="text-xl sm:text-2xl font-semibold mt-6 mb-4 text-primary">Purposes for which we process Personal Data</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl sm:text-2xl font-semibold mt-6 mb-4 text-primary">Transfer of Personal Data</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl sm:text-2xl font-semibold mt-6 mb-4 text-primary">Data Retention</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl sm:text-2xl font-semibold mt-6 mb-4 text-primary">Changes to this Privacy Policy</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl sm:text-2xl font-semibold mt-6 mb-4 text-primary">Contact Details</h2>
          <p className="mb-4">
            ...
            <a href="mailto:info@g3cyberspace.com" className="text-primary underline"> info@g3cyberspace.com</a>.
          </p>
        </div>
      </div>
      <Footer/>
