...
const ComplianceCard: React.FC<{ title: string; image: string }> = ({ title, image }) => {
  return (
    <div className="w-full sm:w-48 h-48 border-primary border-2 bg-white rounded-lg shadow-[5px_5px_5px_#4096B5] p-4 transform transition duration-300 hover:scale-105 hover:shadow-2xl text-center flex flex-col items-center justify-center animate-slidein mt-0">
...
const CompliancePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center px-4 sm:px-6 lg:px-8">
      <div className="py-12">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-semibold mb-54 sm:mb-6 text-center text-800 text-primary mb-4">Compliance Services</h1>
