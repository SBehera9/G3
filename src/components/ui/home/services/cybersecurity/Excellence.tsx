  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-16 py-8 space-y-16 flex flex-col items-center">
      <div className="text-center px-4">
        <p className="text-sm sm:text-base md:text-lg lg:text-xl font-bold text-primary mb-2 animate-slidein">
          Cybersecurity Excellence
        </p>
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold mb-54 sm:mb-6 text-center text-primary animate-slidein">
