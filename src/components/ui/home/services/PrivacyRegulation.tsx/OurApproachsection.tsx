  ...
  return (
    <div className="flex justify-center p-4">
      ...
      <div className="w-full sm:w-3/4 md:w-2/3 lg:w-1/2 p-4">
        <h2
          className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-primary"
          data-aos="fade-up" 
        >
          Our Approach
        </h2>
        ...
        {items.map((item, index) => (
          <div key={index} className="border-b border-gray-300 mb-4">
            <div
              ...
              data-aos="fade-in" 
            >
              <h4 className="text-lg sm:text-xl md:text-1xl font-bold text-primary">{item.title}</h4>
            </div>
            {openIndex === index && (
              <p
